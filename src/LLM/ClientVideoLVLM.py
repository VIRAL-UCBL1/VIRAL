...
if __name__ == '__main__':
    ...
    print(clientVideo.generate_simple_response('In this video, an object is in motion. Describe the motion of the object', 'records/LunarLander-v3/LunarLander-v3_757152-episode-0.mp4'))